# ============================================================
#  RevCode - Revit 2025 C# Code Editor  |  No-Admin Installer
...
$SourceDir      = Join-Path $ScriptDir "src\RevCode\bin\Release"
...
function Write-Banner {
    ...
    Write-Host "    C# Code Editor for Revit"             -ForegroundColor Cyan
...
$sourceAddin = Join-Path $ScriptDir "src\RevCode\RevCode.addin"
...
$defaultScriptDir = Join-Path $ScriptDir 'src\RevCode\DefaultScripts'
...
Write-Host "  ======================================" -ForegroundColor Green
Write-Host ""
Write-Host "  Launch Revit $RevitVersion to use RevCode v$AppVersion." -ForegroundColor White
