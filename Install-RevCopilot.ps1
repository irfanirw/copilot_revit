# ============================================================
#  RevCopilot - Revit 2025 M365 Copilot  |  No-Admin Installer
#  Author: Irfan Irwanuddin
# ============================================================
#
#  Usage:   Right-click -> "Run with PowerShell"
#           or:  powershell -ExecutionPolicy Bypass -File Install-RevCopilot.ps1
#
#  To uninstall:  powershell -ExecutionPolicy Bypass -File Install-RevCopilot.ps1 -Uninstall
#
# ============================================================
...
$SourceDir      = Join-Path $ScriptDir "src\RevCopilot\bin\Release"

# ---- Helper ----
function Write-Banner {
    Write-Host ""
    Write-Host "  ======================================" -ForegroundColor Cyan
    Write-Host "    RevCopilot v$AppVersion"              -ForegroundColor Cyan
    Write-Host "    Microsoft 365 Copilot for Revit"     -ForegroundColor Cyan
...
$sourceAddin = Join-Path $ScriptDir "src\RevCopilot\RevCopilot.addin"
...
Write-Host "  ======================================" -ForegroundColor Green
Write-Host ""
Write-Host "  Launch Revit $RevitVersion to use RevCopilot v$AppVersion." -ForegroundColor White
