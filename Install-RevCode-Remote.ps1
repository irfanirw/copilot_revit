# ============================================================
#  RevCode - Remote Installer
#  Downloads the latest release from GitHub and installs it.
#  Author: Irfan Irwanuddin
# ============================================================
#
#  One-liner usage (PowerShell):
#    & ([scriptblock]::Create((irm 'https://raw.githubusercontent.com/irfanirw/copilot_revit/main/Install-RevCode-Remote.ps1').Content))
#
#  One-liner usage (Command Prompt / any terminal):
#    powershell -ExecutionPolicy Bypass -Command "& ([scriptblock]::Create((Invoke-WebRequest -Uri 'https://raw.githubusercontent.com/irfanirw/copilot_revit/main/Install-RevCode-Remote.ps1').Content))"
#
...
$Branch     = "main"
$PackageDir = "RevCode_v1.0.0"

# ---- Banner ----
Write-Host ""
Write-Host "  ======================================" -ForegroundColor Cyan
if ($Uninstall) {
    Write-Host "    RevCode - Remote Uninstaller"         -ForegroundColor Cyan
} else {
    Write-Host "    RevCode - Remote Installer"           -ForegroundColor Cyan
}
...
$TempDir = Join-Path $env:TEMP "RevCode_Install_$(Get-Random)"
...
try {
    ...
    $PackagePath    = Join-Path $ExtractedRoot $PackageDir
    $InstallerScript = Join-Path $PackagePath "Install-RevCode.ps1"
    ...
    if (-not (Test-Path $InstallerScript)) {
        ...
        Write-Host ""
        Write-Host "  The repository structure may have changed." -ForegroundColor Yellow
