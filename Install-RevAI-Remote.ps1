...
$Branch        = "main"
$InstallerName = "Install-RevAI.ps1"   # lives at repo root

# ---- Banner ----
Write-Host ""
Write-Host "  ======================================" -ForegroundColor Cyan
if ($Uninstall) {
    Write-Host "    RevAI - Remote Uninstaller"           -ForegroundColor Cyan
} else {
    Write-Host "    RevAI - Remote Installer"             -ForegroundColor Cyan
}
...
$TempDir = Join-Path $env:TEMP "RevAI_Install_$(Get-Random)"
